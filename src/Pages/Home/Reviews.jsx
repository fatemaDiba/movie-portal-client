        ...
        <div className="max-w-7xl mx-auto px-6 md:px-12 xl:px-6">
          ...
          <div className="md:columns-2 lg:columns-3 gap-8 space-y-8">
            <div className="h-80 aspect-auto p-8 border border-gray-100 rounded-3xl bg-white dark:bg-gray-800 dark:border-gray-700 shadow-2xl shadow-gray-600/10 dark:shadow-none bg-gradient-to-r from-purple-300 to-pink-300">
              ...
              <p className="mt-8">
                I absolutely love this website! It’s my go-to place for finding
                new movies to watch. The recommendations are spot-on, and I love
                how easy it is to see ratings and reviews before watching a
                film. Highly recommend to anyone who loves cinema!
              </p>
            </div>
            ...
            <div className="h-80 aspect-auto p-8 border border-gray-100 rounded-3xl bg-white dark:bg-gray-800 dark:border-gray-700 shadow-2xl shadow-gray-600/10 dark:shadow-none bg-gradient-to-r from-purple-300 to-pink-300">
              ...
              <p className="mt-8">
                This site has become my favorite for movie reviews and streaming
                suggestions. I can easily find both popular films and hidden
                gems that I would have missed otherwise. The layout is clean and
                intuitive. A must-visit for movie lovers!
              </p>
            </div>
            ...
            <div className="h-80 aspect-auto p-8 border border-gray-100 rounded-3xl bg-white dark:bg-gray-800 dark:border-gray-700 shadow-2xl shadow-gray-600/10 dark:shadow-none bg-gradient-to-r from-purple-300 to-pink-300">
              ...
              <p className="mt-8">
                ...
                website has everything I need. The recommendations are diverse,
                and fit my taste. Plus, the site looks amazing and runs
                smoothly!
              </p>
            </div>
            ...
            <div className="h-80 aspect-auto p-8 border border-gray-100 rounded-3xl bg-white dark:bg-gray-800 dark:border-gray-700 shadow-2xl shadow-gray-600/10 dark:shadow-none bg-gradient-to-r from-purple-300 to-pink-300">
              ...
              <p className="mt-8">
                ...
                From blockbuster hits to indie gems, it offers detailed reviews,
                ratings, and an easy-to-navigate interface. Highly recommended!
              </p>
            </div>
          </div>
        </div>
